  ...
  return (
    <aside className="flex h-full w-14 shrink-0 flex-col items-center border-r border-chrome-border bg-chrome py-4">
      ...
      <button
        ...
        title="Sign out"
        className="flex h-10 w-10 items-center justify-center rounded-lg text-chrome-text transition-colors hover:bg-chrome-light hover:text-chrome-text-strong"
        style={{ transitionDuration: "var(--duration-fast)" }}
      >
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
